...
import { JOURNAL_ICON, JOURNAL_ICON_FOCUSED } from '../../assets/icons/Journal';
  ...
  return (
    <Stack.Navigator
      ...
      <Stack.Screen name="ArticleListScreen" options={{title: 'Articles'}}>
        {props => (
          <ArticleListScreen {...props} user={user} articles={articles} />
        )}
      </Stack.Screen>
      <Stack.Screen name="ArticleDetail" options={{title: 'Articles'}}>
        {props => <ArticleDetail {...props} user={user} articles={articles} />}
      </Stack.Screen>
    </Stack.Navigator>
  );
}
  ...
  return (
    <Stack.Navigator
      ...
      <Stack.Screen name="GoalHistory" options={{title: 'Goal History'}}>
        {props => <GoalHistory {...props} user={user} />}
      </Stack.Screen>
    </Stack.Navigator>
  );
}
...
function ProfileNavigator({user, logout}) {
  return (
    <Stack.Navigator
      ...
      <Stack.Screen
        name="ProfileScreen"
        children={() => <ProfileScreen logout={logout} user={user} />}
      />
    </Stack.Navigator>
  );
}
  ...
  return (
    <Drawer.Navigator
      ...
      <Drawer.Screen
        ...
        {props => (
          <ArticleNavigator {...props} user={user} articles={articles} />
        )}
      </Drawer.Screen>
      <Drawer.Screen
        style={styles.drawerScreen}
      ...
      <Drawer.Screen
        ...
        {props => <GoalHistoryNavigator {...props} user={user} />}
      </Drawer.Screen>
    </Drawer.Navigator>
  );
}
      ...
      <NavigationContainer>
        <Tab.Navigator
          screenOptions={({route}) => ({
            tabBarIcon: ({focused}) => {
              ...
              if (route.name === 'HomeScreens') {
                ...
                return (
                  <Image
                    source={focused ? JOURNAL_ICON_FOCUSED : JOURNAL_ICON}
                    resizeMode="contain"
                  />
                );
              }
              ...
              return (
                <Icon
                  ...
                  color={focused ? BLACK : MEDIUM_GREY}
                  size={24}
                />
              );
            },
          ...
          <Tab.Screen
            ...
            children={() => (
              <ProfileNavigator logout={logout} user={userName} />
            )}
          />
        </Tab.Navigator>
      </NavigationContainer>
